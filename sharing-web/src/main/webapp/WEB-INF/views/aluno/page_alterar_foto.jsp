		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<form role="form" action="/aluno/alterarFoto" method="post" enctype="multipart/form-data">
						<div class="form-group">
							<label class="control-label" for="imagem">Selecione uma imagem</label>
							<input id="imagem" name="imagem" type="file" value=""/>
						</div>
