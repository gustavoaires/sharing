...
<body>
	...
	<span class="text-info"><h4 align="center">${mensagem}
			${status}</h4></span>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-offset-3 col-md-6"
						...
						<p>
							<form class="form-horizontal" role="form" action="/atendimento/avaliarAtendimento" method="post">
								<div class="form-group">
									<input type="hidden" name="id" value="${a.id}"/>
									<label class="control-label text-muted"
										for="nota">Nota do atendimento</label>
								...
								<button type="submit" class="btn btn-primary" id="btn-entrar-modal">Avaliar</button>
							</form>
						</p>
					...
					<div class="row">
						<div class="col-md-offset-1 btn-group" role="group">
							<button id="btnGroupDrop1" type="button"
								...
								aria-haspopup="true" aria-expanded="false">Pedidos que
								eu fiz</button>
							<div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
								<a class="dropdown-item"
									href="/atendimento/verMeusPedidosAtendimentosFeitos?status=aberto">Abertos</a>
								<br /> <a class="dropdown-item"
									href="/atendimento/verMeusPedidosAtendimentosFeitos?status=negado">Negados</a>
								<br /> <a class="dropdown-item"
									href="/atendimento/verMeusPedidosAtendimentosFeitos?status=confirmado">Confirmados</a>
								<br /> <a class="dropdown-item"
									href="/atendimento/verMeusPedidosAtendimentosFeitos?status=avaliado">Avaliados</a>
								<br />
							</div>
						</div>
						<div class="col-md-offset-4 btn-group" role="group">
							...
							<div class="dropdown-menu" aria-labelledby="btnGroupDrop2">
								<a class="dropdown-item"
									href="/atendimento/verMeusPedidosAtendimentosRecebidos?status=aberto">Abertos</a>
								<br /> <a class="dropdown-item"
									href="/atendimento/verMeusPedidosAtendimentosRecebidos?status=negado">Negados</a>
								<br /> <a class="dropdown-item"
									href="/atendimento/verMeusPedidosAtendimentosRecebidos?status=confirmado">Confirmados</a>
								<br /> <a class="dropdown-item"
									href="/atendimento/verMeusPedidosAtendimentosFeitos?status=avaliado">Avaliados</a>
								<br />
							</div>
