			...
			<div class="container">
				<div class="row">
					<div class="col-md-offset-3 col-md-6"
						...
						<c:if test="${a.idPediuAjuda != aluno_logado.login}">
							<p align="right">
								<a href="/atendimento/confirmarAtendimento?id=${a.id}"
									class="btn btn-success">Confirmar</a> <a
									href="/atendimento/negarAtendimento?id=${a.id}"
									class="btn btn-danger">Negar</a>
							</p>
						</c:if>
						<c:if test="${a.idPediuAjuda eq aluno_logado.login}">
							<p>
								<a href="/atendimento/cancelarAtendimento?id=${a.id}"
